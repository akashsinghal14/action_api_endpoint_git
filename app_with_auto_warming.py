...
def warm_cache_automatically():
    ...
    for i, combo in enumerate(common_combinations):
        try:
            ...
            # Handle boolean measurements
            elif measurement_type in ['intustrips', 'selfclosing', 'shutsign', 'holddevice', 'certivisible', 'glazing', 'pyroglazing', 'doorclosefully', 'hingesfirerated']:
                ...
                if measurement_type == 'intustrips':
                    result = handle_boolean_measurement_internal('intumescent_strips', str(value), api_key, model, ai_provider, 'high')
                elif measurement_type == 'selfclosing':
                    result = handle_boolean_measurement_internal('self_closing_device', str(value), api_key, model, ai_provider, 'high')
                    ...
                    result = handle_boolean_measurement_internal('contains_glazing', str(value), api_key, model, ai_provider, 'medium')
                    ...
                    result = handle_boolean_measurement_internal('door_close_fully', str(value), api_key, model, ai_provider, 'high')
                elif measurement_type == 'hingesfirerated':
                    result = handle_boolean_measurement_internal('hinges_fire_rated', str(value), api_key, model, ai_provider, 'high')
